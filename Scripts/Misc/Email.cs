...
namespace Server.Misc
{
	public class Email
	{
		...
		public static readonly string EmailServer = "mail.casiopia.net";
		public static readonly int Port = 25;
		public static readonly bool EnableSSL = false;

		public static readonly string CrashAddresses = "kamron@casiopia.net";
		public static readonly string SpeechLogPageAddresses = "kamron@casiopia.net";
		private static readonly NetworkCredential m_SmtpCredentials = new NetworkCredential( "kamron+casiopia.net", "auth54123" );
