...
*/
		...
		private static void SetName( Mobile m, string name )
		{
			...
			{
				NameResultMessage result = NameVerification.ValidatePlayerName( name, 2, 16, true, false, true, 1, NameVerification.SpaceDashPeriodQuote );

				if ( result != NameResultMessage.Allowed )
					m.Name = String.Format( "Generic Player {0}", Utility.Random( 10000, 99999 ) );
				else
					m.Name = name;
			}
			else
...
*/
		...
		private static void PackScroll( int circle )
		{
			switch ( Utility.Random( 8 ) + (circle + 1) )
			{
				...
				case 32: PackItem( new BladeSpiritsScroll() ); break;
				//Fifth
				case 33: PackItem( new DispelFieldScroll() ); break;
				case 34: PackItem( new IncognitoScroll() ); break;
				case 35: PackItem( new MagicReflectScroll() ); break;
				case 36: PackItem( new MindBlastScroll() ); break;
				case 37: PackItem( new ParalyzeScroll() ); break;
				case 38: PackItem( new PoisonFieldScroll() ); break;
				case 39: PackItem( new SummonCreatureScroll() ); break;
				//Sixth
				case 40: PackItem( new DispelScroll() ); break;
				case 41: PackItem( new EnergyBoltScroll() ); break;
				case 42: PackItem( new ExplosionScroll() ); break;
				case 43: PackItem( new InvisibilityScroll() ); break;
				case 44: PackItem( new MarkScroll() ); break;
				case 45: PackItem( new MassCurseScroll() ); break;
				case 46: PackItem( new ParalyzeFieldScroll() ); break;
				case 47: PackItem( new RevealScroll() ); break;
			}
		}
