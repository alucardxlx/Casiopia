...
namespace Server.Items
{
	...
	{
		public override int EmptyLabelNumber{ get{ return 1043007; } } //a jug
	...
	public class CeramicMug : BaseBeverage
	{
		...
		public override int ComputeItemID()
		{
			if ( ItemID >= 0x995 && ItemID <= 0x999 || ItemID == 0x9CA )
				return ItemID;
		...
		public virtual void Pour_OnTarget( Mobile from, object targ )
		{
			...
			else if ( from == targ )
			{
				if ( ContainsAlchohol )
				{
					...
					from.SendMessage( "The acoholic beverage makes you more thirsty." );
